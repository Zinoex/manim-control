...
class BetterVectorField(VGroup):
    """A vector field.
    ...
    def stop_submobject_movement(self) -> BetterVectorField:
...
class BetterArrowVectorField(BetterVectorField):
...
class BetterStreamLines(BetterVectorField):
